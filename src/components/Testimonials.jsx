...
const Testimonial = () => {
    ...
    return (
        <div>
            <section className={`${!loading ? "text-gray-600 body-font mb-10" : "none"}`}>
                {/* main  */}
                <div className="container px-5 py-10 mx-auto">
                    {/* Heading  */}
                    <h1 className=' text-center text-3xl font-bold text-black' >Testimonial</h1>
                    {/* para  */}
                    <h2 className=' text-center text-2xl font-semibold mb-10' >What our <span className='text-#E9EAEB'>customers</span> are saying</h2>
