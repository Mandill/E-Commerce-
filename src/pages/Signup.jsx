...
const Signup = () => {
  ...
  return (
            <div className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[60%] flex flex-col text-gray-700 bg-transparent p-6 rounded-xl bg-clip-border mt-[55px]  shadow-xl">
            {loadingStatus.loading && <Loader/>} 
            <h4 className="block text-center font-sans text-2xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
                Sign Up
            </h4>
            <p className="block text-center mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
                Nice to meet you! Enter your details to register.
            </p>
            <form className="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96 m-auto ">
